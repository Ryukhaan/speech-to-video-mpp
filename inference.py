        ...
        for p, f, xf, c in zip(pred, frames, f_frames, coords):
            ...
            if args.cropped_image:
                ...
                for j, (x,y) in enumerate(nose):
                    xi, yi = int(inverse_scale_x*x + ox1), int(y + oy1)
                    xj, yj = int(inverse_scale_x*nose[j - 1][0] + ox1), int(nose[j - 1][1] + oy1)
                ...
                for j, (x,y) in enumerate(bottom_face):
                    xi, yi = int(inverse_scale_x*x + ox1), int(y + oy1)
                    xj, yj = int(inverse_scale_x*bottom_face[j - 1][0] + ox1), int(bottom_face[j - 1][1] + oy1)
